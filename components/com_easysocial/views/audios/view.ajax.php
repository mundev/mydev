...
class EasySocialViewAudios extends EasySocialSiteView
{
	 ...
	 * @access	public
	 */
	public function getAudios($audios = array(), $featuredAudios = array(), $pagination = null, $filter = null, $adapter, $rawUid, $uid, $type, $hashtags, $tagsFilter, $isSortingRequest, $from = false, $genreId = false, $activeGenre = false, $cluster = null)
	{
		$output = '';
