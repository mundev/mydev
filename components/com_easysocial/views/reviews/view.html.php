...
class EasySocialViewReviews extends EasySocialSiteView
{
	 ...
	 * @access	public
	 */
	public function saveReview($clusterId)
	{
		...
		$permalink = $cluster->getAppPermalink('reviews');
	 ...
	 * @access	public
	 */
	public function delete($reviews, $cluster)
	{
		$this->info->set($this->getMessage());

		$redirect = $cluster->getAppPermalink('reviews', false);
	 ...
	 * @access	public
	 */
	public function approve($reviews, $cluster)
	{
		$this->info->set($this->getMessage());
	 ...
	 * @access	public
	 */
	public function reject($reviews, $cluster)
	{
		$this->info->set($this->getMessage());
