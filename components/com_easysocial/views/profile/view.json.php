...
class EasySocialViewProfile extends EasySocialSiteView
{
    ...
    public function display($tpl = null)
    {
        ...
        // If there is no method exist, display user information by default
    ...
    public function getUserInfo()
    {
        ...
        $this->set('id', $user->id);
        $this->set('isself', $user->isViewer());
        $this->set('isfriend', $user->isFriends($my->id));
        $this->set('isfollower', $user->isFollowed($my->id));
        ...
        $steps = ES::model('steps')->getSteps($user->getWorkflow()->id, SOCIAL_TYPE_PROFILES, SOCIAL_PROFILES_VIEW_DISPLAY);
        $fields = ES::model('fields')->getCustomFields(array('workflow_id' => $user->getWorkflow()->id, 'data' => true, 'dataId' => $user->id, 'dataType' => SOCIAL_TYPE_USER, 'visible' => SOCIAL_PROFILES_VIEW_DISPLAY));
