					...
					<div class="es-apps-item__meta-item">
						<ol class="g-list-inline g-list-inline--dashed">
							...
							<li>
								...
								<a href="<?php echo $review->author->getPermalink(); ?>">
									<?php echo $review->author->getName();?>
								</a>
							</li>
							<?php } ?>
							...
							<li>
								<i class="fa fa-clock-o"></i>&nbsp; <?php echo ES::date($review->created)->format(JText::_('DATE_FORMAT_LC'));?>
							</li>
							<?php } ?>
						</ol>
					</div>
