	...
	<div class="o-form-horizontal">
		<div class="o-form-group">
			...
			<div class="o-control-input">
				<input type="text" placeholder="<?php echo JText::_('COM_EASYSOCIAL_POLLS_SET_A_TITLE');?>" class="o-form-control" name="title" value="<?php echo $poll->title;?>" autocomplete="off" data-polls-title />
			...
			<div class="o-control-input">
				<div class="o-grid o-grid--1of3">
					<div class="o-grid__cell">
						<div id="datetimepicker4" class="o-input-group" data-polls-expiration data-value="<?php echo ($poll->expiry_date != '' && $poll->expiry_date != '00-00-00 00:00:00') ? ES::date($poll->expiry_date)->toFormat('Y-m-d H:i:s') : '';?>">
