...
<div class="<?php echo !$polls ? ' is-empty' : '';?> es-cards es-cards--2" data-result>
					...
					<ul class="g-list-inline g-list-inline--space-right">
						...
						<li>
							<span class="o-label o-label--danger-o">
								<i class="fa fa-clock-o"></i> <?php echo JText::_('COM_EASYSOCIAL_POLLS_EXPIRED'); ?>
							</span>
						</li>
						<?php } ?>
					</ul>
	...
	<?php echo $this->html('html.emptyBlock', $filter == 'mine' ? 'COM_EASYSOCIAL_POLLS_NEVER_CREATED_YET' : ($filter == 'user' ? 'COM_ES_POLLS_USER_EMPTY' : 'COM_EASYSOCIAL_POLLS_EMPTY_POLLS'), 'fa-bar-chart'); ?>
</div>
