...
<?php if ($streamFilter) { ?>
	<div class="es-snackbar es-hashtag">
		...
		<div class="es-snackbar__cell">
			...
			href="<?php echo ESR::groups(array('layout' => 'item', 'id' => $group->getAlias(), 'type' => 'filterForm', 'filterId' => $streamFilter->getAlias()));?>">
...
<div class="es-snackbar es-hashtag">
	<div class="es-snackbar__cell">
		<h1 class="es-snackbar__title"><?php echo JText::sprintf('COM_EASYSOCIAL_STREAM_HASHTAG_CURRENTLY_FILTERING' , '<a href="' . ESR::groups(array('layout' => 'item', 'id' => $group->getAlias(), 'tag' => $hashtagAlias )) . '">#' . $hashtag . '</a>'); ?></h1>
	</div>
	<?php if ($group->canCreateStreamFilter()) { ?>
	<div class="es-snackbar__cell">
