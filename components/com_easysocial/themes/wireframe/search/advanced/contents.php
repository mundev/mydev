...
<div>
	...
	<div class="es-adv-search2 es-island <?php echo $results || $activeFilter->id ? 't-hidden' : '';?>" data-search-form>
		<form name="frmAdvSearch" method="post" action="<?php echo ESR::search($routerSegment); ?>" data-form>
			...
			<div class="o-form-actions es-bleed--bottom">
				...
				<button class="btn btn-es-primary-o t-lg-pull-right" type="submit" data-advsearch-button>
					<?php echo JText::_('COM_EASYSOCIAL_ADVANCED_SEARCH_SEARCH_BUTTON');?>
				</button>

				<?php if ($this->my->id && $activeFilter->id) { ?>
...
<div class="t-lg-mt--md <?php echo !$results ? 'is-empty' : '';?>">
	<div class="es-search-result">
		<?php if ($results || $activeFilter->id) { ?>
		<div class="es-island t-lg-mb--xl">
			<div class="o-grid">
				...
				<div class="o-grid__cell--auto-size">
					<?php if ($results && !$activeFilter->id) { ?>
					<a href="javascript:void(0);" class="btn btn-es-default-o btn-sm" data-edit-criteria><?php echo JText::_('COM_EASYSOCIAL_EDIT_SEARCH_CRITERIA'); ?></a>

					<a href="javascript:void(0);" class="btn btn-es-default-o btn-sm" data-save-filter><?php echo JText::_('COM_EASYSOCIAL_ADVANCED_SEARCH_CREATE_FILTER'); ?></a>
					<?php } ?>
