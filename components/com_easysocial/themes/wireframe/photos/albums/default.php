...
?>
<div class="layout-<?php echo $options['layout'];?> es-media-item es-photo-item<?php echo $photo->isFeatured() ? ' featured' : '';?>"  data-photo-item="<?php echo $photo->uuid(); ?>"  data-photo-id="<?php echo $photo->id; ?>" 
	<?php if ($options['layout'] != 'form' && $options['size'] != 'large') { ?>
