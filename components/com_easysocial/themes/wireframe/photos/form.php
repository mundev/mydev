...
<div class="es-photo-form" data-photo-form>
	...
	<div class="es-photo-form-fields">
		...
		<textarea class="es-photo-caption-field" data-photo-caption-field placeholder="<?php echo JText::_("COM_EASYSOCIAL_ENTER_PHOTO_CAPTION"); ?>"><?php echo $photo->caption; ?></textarea>
