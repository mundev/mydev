	...
	<div class="es-cards es-cards--2">
		<?php if ($audios) { ?>
			<?php foreach ($audios as $audio) { ?>
				<?php echo $this->loadTemplate('site/audios/default/item', array('audio' => $audio, 'uid' => $rawUid, 'utype' => $type, 'returnUrl' => $returnUrl, 'browseView' => $browseView, 'from' => $from, 'lists' => $lists)); ?>
			<?php } ?>
		<?php } ?>
	</div>
</div>
