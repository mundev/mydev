	...
	<?php if ($tagsFilter->id) { ?>
		<div class="es-snackbar">
			<div class="es-snackbar__cell">
				<?php echo JText::sprintf('COM_ES_AUDIO_CUSTOM_FILTER_HEADER_TITLE', $tagsFilter->title); ?>
			</div>
			<div class="es-snackbar__cell">
				<a 
				...
				href="<?php echo $tagsFilter->getEditLink();?>" class="pull-right"><?php echo JText::_('COM_ES_AUDIO_FILTERS_EDIT_FILTER'); ?></a>
			</div>
		</div>
		<p><?php echo $tagsFilter->getHashtagsLink($hashtags, 'audios', $uid, $type); ?></p>
	<?php } else { ?>
		<div class="es-snackbar">
			<div class="es-snackbar__cell">
				<?php echo $tagsFilter->getHashtagsLink($hashtags, 'audios', $uid, $type); ?>
			</div>
		</div>
	<?php } ?>
<!-- Default Snackbar -->
