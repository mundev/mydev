...
<dialog>
	...
	<buttons>
		...
		<button data-send-button type="button" data-post-as="user" class="btn btn-es-primary btn-sm"><?php echo JText::_('COM_EASYSOCIAL_REPOST_SUBMIT_BUTTON'); ?></button>
		<?php if ($showPostAsButton) { ?>
			<button data-send-button type="button" data-post-as="page" class="btn btn-es-primary btn-sm"><?php echo JText::_('COM_EASYSOCIAL_REPOST_SUBMIT_AS_PAGE_BUTTON'); ?></button>
		<?php } ?>
	</buttons>
</dialog>
