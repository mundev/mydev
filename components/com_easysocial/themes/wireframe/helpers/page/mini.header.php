			...
			<nav class="o-nav o-nav--block es-nav-pills">
				...
				<span class="o-nav__item">
					<a href="<?php echo $page->getAppPermalink('followers');?>" class="o-nav__link">
						<i class="fa fa-thumbs-o-up"></i>&nbsp; <?php echo JText::sprintf(ES::string()->computeNoun('COM_EASYSOCIAL_PAGES_LIKERS', $page->getTotalMembers()), '<b>' . $page->getTotalMembers() . '</b>'); ?>
					</a>
				</span>
				...
				<span class="o-nav__item">
					<a href="<?php echo ESR::albums(array('uid' => $page->getAlias(), 'type' => SOCIAL_TYPE_PAGE));?>" class="o-nav__link">
						<i class="fa fa-photo"></i>&nbsp; <?php echo JText::sprintf(ES::string()->computeNoun('COM_EASYSOCIAL_PAGES_ALBUMS', $page->getTotalAlbums()), '<b>' . $page->getTotalAlbums() . '</b>'); ?>
					</a>
				</span>
				<?php } ?>
