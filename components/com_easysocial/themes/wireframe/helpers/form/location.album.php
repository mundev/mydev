...
?>
<div class="es-locations <?php echo $classname; ?>" <?php echo $selectorName; ?> data-language="<?php echo $this->config->get('general.location.language'); ?>">
    ...
    <div class="es-location-buttons">
        <button type="button" class="es-location-button btn btn-es-default-o btn-sm" data-detect-location-button>
