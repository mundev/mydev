...
?>
<div class="es-story-audio-form<?php echo ($isEdit && $audio->id) ? ' is-processed' : ' is-waiting'; ?>" data-audio-form>
		...
		<div class="es-audio-item-content">
			...
			<div class="es-audio-item-album-textbox">
				<input type="text"
					...
					value="<?php echo $audio->album; ?>" />
			</div>

			<div class="es-audio-item-desp" data-audio-preview-description><?php echo ($audio->description) ? $audio->description : JText::_('COM_ES_AUDIO_STORY_ENTER_DESC');?></div>
			...
			<div data-audio-uploader class="es-audio-content">
				<div data-audio-uploader-dropsite>
					<div data-audio-uploader-button class="es-audio-upload-button">
						<span>
							<b class="add-hint">
								<i class="fa fa-upload"></i> <?php echo JText::_('COM_ES_AUDIO_CLICK_OR_DROP_AUDIO');?>
							</b>
						</span>
					</div>
				</div>
