...
?>
<div class="es-story-video-form<?php echo ($isEdit && $video->id) ? ' is-processed' : ' is-waiting'; ?>" data-video-form>
	...
	<div class="es-video-item-wrap video-result" data-result>
		...
		<div class="es-video-item-content">
			...
			<div class="es-video-item-desp" data-video-preview-description><?php echo ($video->description) ? $video->description : JText::_('COM_EASYSOCIAL_STORY_VIDEOS_ENTER_DESC');?></div>
			<div class="es-video-item-desp-textbox">
				<textarea class="es-story-link-description-textfield o-form-control input-sm"
						  ...
						  ><?php echo $video->description; ?></textarea>
			</div>
