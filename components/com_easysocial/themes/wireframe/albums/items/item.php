	...
	<div class="es-card es-card--album-item<?php echo !$photos ? ' is-empty' : ''; ?>">
		...
		<div class="es-card__bd es-card--border">
			...
			<?php if ($album->getLocation() && $this->config->get('photos.location')) { ?>
				...
				<div class="es-card__meta"><i class="fa fa-map-marker"></i>
					<u data-popbox="module://easysocial/locations/popbox" data-lat="<?php echo $location->latitude; ?>"
					data-lng="<?php echo $location->longitude; ?>">
						<a href="//maps.google.com/?q=<?php echo $location->latitude; ?>,<?php echo $location->longitude; ?>" target="_blank">
