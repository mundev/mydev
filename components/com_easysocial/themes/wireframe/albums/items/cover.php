...
<div class="embed-responsive embed-responsive-16by9">
	<div class="o-empty">
		<div class="o-empty__content">
			<i class="o-empty__icon fa fa-photo"></i>
			<div class="o-empty__text"><?php echo JText::_('COM_EASYSOCIAL_ALBUMS_ALBUM_IS_EMPTY'); ?></div>
			<div class="o-empty__action">
				<a href="<?php echo $album->getPermalink();?>" class="btn btn-es-primary-o btn-sm"><?php echo JText::_('COM_EASYSOCIAL_ALBUMS_ADD_PHOTO'); ?></a>
			</div>
		</div>
	</div>
</div>
