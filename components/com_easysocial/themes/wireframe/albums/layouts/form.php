...
<div class="es-album-form">
	<div class="es-album-form-fields <?php echo ($album->core) ? 'core-album' : ''; ?>">
		...
		<textarea class="es-album-caption-field" placeholder="<?php echo JText::_("COM_EASYSOCIAL_ALBUMS_ENTER_ALBUM_DESCRIPTION"); ?>" data-album-caption-field <?php echo ($album->core) ? 'readonly' : ''; ?>><?php echo $this->html('string.escape', $album->_('caption')); ?></textarea>
