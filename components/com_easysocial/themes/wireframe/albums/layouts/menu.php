...
<div class="es-album-menu es-media-item-menu es-album-menu-item">
	...
	<div class="btn-group btn-group--album-upload" data-album-upload-button>
...
<div class="es-album-menu es-media-item-menu es-album-menu-form">
	...
	<div class="btn-group">
		<?php if ($album->id) { ?>
		<a href="<?php echo $album->getPermalink();?>" class="btn btn-es-default-o btn-sm" title="<?php echo $lib->getPageTitle('item');?>" data-album-cancel-button>
