...
<div class="es-list-result">
	...
	<div data-result-list>
		...
		<?php } else { ?>
			<?php echo $this->loadTemplate('site/videos/default/item.list', array('videos' => $videos, 'pagination' => $pagination, 'rawUid' => $rawUid, 'type' => $type, 'browseView' => $browseView, 'from' => $from, 'returnUrl' => $returnUrl)); ?>
		<?php } ?>
