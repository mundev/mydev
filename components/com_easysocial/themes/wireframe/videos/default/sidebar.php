...
<div data-sidebar class="es-sidebar">
	...
	<div class="es-side-widget" data-section data-type="custom-filters">
		<?php echo $this->html('widget.title', 'COM_EASYSOCIAL_CUSTOM_FILTERS', array(
				'link' => $customFilterLink, 
				'icon' => 'fa-plus', 
				'attributes' => 'data-video-create-filter data-type="videos" data-uid="' . $uid . '" data-cluster-type="' . $type . '" title="' . JText::_('COM_EASYSOCIAL_VIDEOS_ADD_FILTERS') . '"'
			)); ?>
