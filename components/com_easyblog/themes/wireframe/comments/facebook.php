...
if (!window.FB) {
	...
	if (!jssdk) {
		...
		var head = document.getElementsByTagName("head")[0],
			...
			script.src = "//connect.facebook.net/<?php echo $language[0];?>_<?php echo EBString::strtoupper($language[1]);?>/sdk.js#xfbml=1&appId=<?php echo $this->config->get('main_facebook_like_appid');?>&version=v2.0";
