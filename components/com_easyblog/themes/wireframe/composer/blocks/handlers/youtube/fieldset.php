...
<div class="eb-composer-fieldset">
	...
	<div class="eb-composer-fieldset-content">
		<div class="text-center">
			<?php echo $this->html('form.toggler', 'youtube_nocookie', false, 'youtube_nocookie', 'data-youtube-fieldset-nocookie'); ?>
		</div>
	</div>
</div>
...
<div class="eb-composer-fieldset">
	<div class="eb-composer-fieldset-header">
		<b><?php echo JText::_('COM_EASYBLOG_COMPOSER_BLOCKS_EMBED_VIDEO_SHOW_RELATED_VIDEOS'); ?></b>
	</div>

	<div class="eb-composer-fieldset-content">
		<div class="text-center">
			<?php echo $this->html('form.toggler', 'youtube_related', true, 'youtube_related', 'data-youtube-fieldset-related'); ?>
		</div>
	</div>
</div>
