...
$rows_file      = $themepath . '/html/layouts/officehelix3/frontend/rows.php';
$lyt_thm_path   = $themepath . '/html/layouts/officehelix3/';

$layout_path  = (file_exists($rows_file)) ? $lyt_thm_path : JPATH_ROOT .'/plugins/system/officehelix3/layouts';
