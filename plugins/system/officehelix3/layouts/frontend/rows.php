...
//helper & model
$helix3_class   = JPATH_ROOT . '/plugins/system/officehelix3/core/classes/officehelix3.php';
...
$carea_file     = $themepath . '/html/layouts/officehelix3/frontend/conponentarea.php';
$module_file    = $themepath . '/html/layouts/officehelix3/frontend/modules.php';
$lyt_thm_path   = $themepath . '/html/layouts/officehelix3/';

$layout_path_carea  = (file_exists($carea_file)) ? $lyt_thm_path : JPATH_ROOT .'/plugins/system/officehelix3/layouts';
$layout_path_module = (file_exists($module_file)) ? $lyt_thm_path : JPATH_ROOT .'/plugins/system/officehelix3/layouts';
