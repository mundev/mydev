...
<div class="es-container">
	...
	<div class="es-content">
		...
		<?php if (isset($cluster) && $cluster) { ?>
			<?php echo $this->html('cover.' . $cluster->getType(), $cluster, 'polls'); ?>

			<?php echo $this->html('html.snackbar', 'APP_POLLS_' . $cluster->getType() . '_TITLE' , 'h2'); ?>
		<?php } ?>
		...
		<form action="<?php echo JRoute::_('index.php?option=com_easysocial&view=polls&layout=create');?>" method="post" class="es-forms">
			...
			<div class="es-forms__group">
				...
				<div class="es-forms__content">
					<div class="es-polls-form">
						<?php echo $polls->form(SOCIAL_TYPE_STREAM, 0, '', '', array('type' => 'form')); ?>
					</div>
				</div>
			</div>
			...
			<div class="es-forms__actions">
				<div class="o-form-actions">
					<a href="<?php echo ESR::polls();?>" class="btn btn-es-default-o t-lg-pull-left"><?php echo JText::_('COM_ES_CANCEL');?></a>
					<button class="btn btn-es-primary-o t-lg-pull-right">
