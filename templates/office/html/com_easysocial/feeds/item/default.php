...
<div class="es-container">
	...
	<div class="es-content">
		...
		<?php echo $this->html('cover.' . $cluster->getType(), $cluster, $this->vars['app']->element); ?>

		<?php echo $this->html('html.snackbar', 'APP_FEEDS_' . $cluster->getType() . '_TITLE' , 'h2'); ?>
								...
								<div class="es-apps-item__meta">
									<div class="es-apps-item__meta-item">
										<ol class="g-list-inline g-list-inline--dashed">
											<li>
												<i class="fa fa-clock-o"></i>&nbsp; <?php echo @$item->get_date(JText::_('COM_EASYSOCIAL_DATE_DMY')); ?>
											</li>
										</ol>
									</div>
								</div>		
