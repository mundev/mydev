		...
		<form action="<?php echo JRoute::_('index.php');?>" method="post" class="es-forms" data-es-review-form>
			...
			<div class="es-forms__actions">
				<div class="o-form-actions">
					<a class="btn btn-es-default-o pull-left" href="<?php echo $cluster->getAppPermalink('reviews');?>"><?php echo JText::_('COM_ES_CANCEL'); ?></a>
			...
			<input type="hidden" name="type" value="<?php echo $cluster->cluster_type; ?>" />
