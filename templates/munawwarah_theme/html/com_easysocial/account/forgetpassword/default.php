		...
		<div class="si-login__bd">
			...
			<form class="si-login__form" action="<?php echo JRoute::_('index.php');?>" method="post">
				...
				<div class="si-login__fields">
					<div class="si-login__form-title"><b><?php echo JText::_('COM_EASYSOCIAL_PROFILE_REMIND_PASSWORD');?></b></div>
					<p class="si-login__form-desc t-lg-mt--lg"><?php echo JText::_('COM_EASYSOCIAL_PROFILE_REMIND_PASSWORD_DESC');?></p>
						...
						<fieldset class="t-lg-mt--lg">
							...
							<div class="">
								<button type="submit" class="btn btn-es-primary btn-block"><?php echo JText::_('COM_EASYSOCIAL_SEND_PASSWORD_BUTTON');?></button>
							</div>
