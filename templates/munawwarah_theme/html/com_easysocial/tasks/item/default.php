...
?>
<div class="es-container" data-tasks-item data-id="<?php echo $milestone->id; ?>" data-uid="<?php echo $cluster->id; ?>">
	...
	<div class="es-content <?php echo $milestone->isDue() ? 'is-due' : ''; ?> <?php echo $milestone->isCompleted() ? 'is-completed' : ''; ?>" data-tasks-wrapper>
		...
		<?php if (isset($cluster) && $cluster) { ?>
			<?php echo $this->html('cover.' . $cluster->getType(), $cluster, 'tasks'); ?>

			<?php echo $this->html('html.snackbar', 'APP_TASKS_' . $cluster->getType() . '_TITLE' , 'h2'); ?>
		<?php } ?>
