						...
						<div class="o-form-group">
							...
							<div class="o-control-input">
								<select id="audio-genre" name="genre_id" class="o-form-control">
									...
									<option value="<?php echo $genre->id;?>"<?php echo $audio->genre_id == $genre->id || $defaultGenre == $genre->id ? ' selected="selected"' : '';?>><?php echo Jtext::_($genre->title);?></option>
									<?php } ?>
								</select>
						...
						<?php if ($audio->canEmbed()) { ?>
							<div class="o-form-group <?php echo $audio->isUpload() ? 't-hidden' : '';?>" data-form-link data-form-source>
								...
								<div class="o-control-input">
									...
									<div class="help-block" data-link-notice><?php echo JText::_('COM_ES_AUDIO_FORM_LINK_TIPS');?></div>
