...
<div class="es-profile-header t-lg-mb--lg">
	<?php if (isset($cluster)) { ?>
		<div class="es-profile-header__back">
			<a href="<?php echo $cluster->getPermalink();?>" class="btn btn-es-primary btn-block t-lg-mb--xl">&larr; <?php echo JText::_('COM_ES_BACK_TO_' . strtoupper($cluster->getType()));?></a>
		</div>
	<?php } ?>
