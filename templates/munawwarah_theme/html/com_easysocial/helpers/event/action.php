...
?>
<?php if ((($event->isClusterEvent() && $isClusterAllowed) 
		|| (!$event->isClusterEvent() && ($event->isOpen() || $isParticipant)))
		&& !$isPending 
		&& !$event->isDraft() 
		&& $this->my->getAccess()->get('events.allow.join') 
		&& !$event->isPassed()
	) { ?>
