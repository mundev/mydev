...
<div data-result>
	...
	<?php if ($featuredPages) { ?>
		<div class="es-snackbar">
			...
			<div class="es-snackbar__cell">
				<a href="<?php echo ESR::groups(array('filter' => 'featured')); ?>" class="t-lg-pull-right"><?php echo JText::_('COM_ES_VIEW_ALL'); ?></a>	
			</div>
		</div>

		<?php echo $this->loadTemplate('site/pages/default/items.list', array('pages' => $featuredPages, 'pagination' => false)); ?>
	<?php } ?>

	<?php if ($pages && $browseView) { ?>
