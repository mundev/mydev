...
<div class="es-container">
	...
	<div class="es-content">
		<?php echo $this->html('cover.' . $cluster->getType(), $cluster, 'discussions'); ?>

		<?php echo $this->html('html.snackbar', 'APP_DISCUSSIONS_' . $cluster->getType() . '_TITLE' , 'h2'); ?>
		...
		<form action="<?php echo JRoute::_('index.php');?>" method="post" class="es-forms">
			...
			<div class="es-forms__actions">
				<div class="o-form-actions">
					...
					<button type="submit" class="pull-right btn btn-es-primary-o"><?php echo JText::_('COM_EASYSOCIAL_SUBMIT_BUTTON'); ?></button>
				</div>
			</div>
