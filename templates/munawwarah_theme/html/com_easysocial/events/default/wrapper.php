...
<?php if (!empty($featuredEvents)) { ?>
	<div class="es-snackbar">
		<div class="es-snackbar__cell">
			<h2 class="es-snackbar__title"><?php echo JText::_('COM_EASYSOCIAL_PAGE_TITLE_EVENTS_FILTER_FEATURED');?></h2>
		</div>

		<div class="es-snackbar__cell">
			<a href="<?php echo ESR::events(array('filter' => 'featured')); ?>" class="t-pull-right"><?php echo JText::_('COM_ES_VIEW_ALL'); ?></a>	
		</div>
	</div>
...
<div>
	<?php if (!$delayed && ($showPastFilter || $showSorting || $showDistanceSorting) && $browseView) { ?>
	<div class="o-grid">
