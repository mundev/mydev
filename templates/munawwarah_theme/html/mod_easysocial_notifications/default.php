...
function isConverseKitInstalled()
{
	static $enabled = null;
	...
	if (is_null($enabled)) {
		...
		$enabled = JPluginHelper::isEnabled('system', 'conversekit');
	}
	    ...
	    <nav class="o-nav">
	        ...
	        <div class="o-nav__item">
	            <a class="o-nav__link mod-es-menu-bar__icon-link <?php echo $my->getTotalFriendRequests() > 0 ? 'has-new' : '';?>" href="javascript:void(0);"
	                data-es-provide="tooltip" data-original-title="<?php echo JText::_('MOD_EASYSOCIAL_NOTIFICATIONS_FRIEND_REQUESTS', true);?>" data-placement="bottom"
	        ...
	        <div class="o-nav__item">
	        	<?php if (isConverseKitInstalled() && Office::isMobile()) { ?>
	        	<a href="javascript:void(0);" class="o-nav__link mod-es-menu-bar__icon-link <?php echo $my->getTotalNewConversations() > 0 ? 'has-new' : '';?>" data-ck-button="" data-start="conversations">
	        	<?php } else { ?>
	            <a class="o-nav__link mod-es-menu-bar__icon-link <?php echo $my->getTotalNewConversations() > 0 ? 'has-new' : '';?>" href="javascript:void(0);"
	                data-es-provide="tooltip" data-original-title="<?php echo JText::_('MOD_EASYSOCIAL_NOTIFICATIONS_CONVERSATIONS', true);?>" data-placement="bottom"
	        ...
	        <div class="o-nav__item">
	            <a class="o-nav__link mod-es-menu-bar__icon-link <?php echo $my->getTotalNewNotifications() > 0 ? 'has-new' : '';?>" href="javascript:void(0);"
	                data-es-provide="tooltip" data-original-title="<?php echo JText::_('MOD_EASYSOCIAL_NOTIFICATIONS_NOTIFICATIONS', true);?>" data-placement="bottom"
