...
var es = {
	...
	installation: {
		...
		{
			es.installation.setActive( 'data-progress-pageapps' );

			es.installation.ajaxCall( 'installApps' , { "group" : "page" } , function( result )
			{
				// Set the progress
				es.installation.update( 'data-progress-pageapps' , result , '46%');
		...
		{
			es.installation.setActive( 'data-progress-pagefields' );

			es.installation.ajaxCall( 'installFields' , { "group" : "page" } , function( result )
			{
				// Set the progress
				es.installation.update( 'data-progress-pagefields' , result , '56%');
		...
		uninstallModules: function() {
			// Install the admin stuffs
			es.installation.setActive('data-progress-uninstall-modules');

			es.installation.ajaxCall('uninstallModules', {}, function(result) {
				// Set the progress
				es.installation.update('data-progress-uninstall-modules', result , '67%');
		...
		installAdminModules: function() {
			// Install the admin stuffs
			es.installation.setActive('data-progress-admin-modules');

			es.installation.ajaxCall('installAdminModules', {}, function(result) {
				// Set the progress
				es.installation.update('data-progress-admin-modules', result , '68%');
		...
		{
			es.installation.setActive('data-progress-workflows');
			es.installation.ajaxCall('installWorkflows', {}, function(result) {
				es.installation.update('data-progress-workflows', result, '83%');
		...
		{
			// Install the admin stuffs
			es.installation.setActive( 'data-progress-pagecategories' );

			es.installation.ajaxCall( 'installDefaultPageCategories' , {} , function( result )
			{
				// Set the progress
				es.installation.update( 'data-progress-pagecategories' , result , '90%');

				if( !result.state )
				{
					es.installation.showRetry( 'installDefaultPageCategories' );
					return false;
				}
		...
		{
			// Install the admin stuffs
			es.installation.setActive( 'data-progress-audiogenres' );

			es.installation.ajaxCall( 'installDefaultAudioGenres' , {} , function( result )
			{
				// Set the progress
				es.installation.update( 'data-progress-audiogenres' , result , '96%');

				if( !result.state )
				{
					es.installation.showRetry( 'installDefaultAudioGenres' );
					return false;
				}
		...
		installAlerts : function()
		{
			...
			{
				// Set the progress
				es.installation.update( 'data-progress-alerts' , result , '97%');
