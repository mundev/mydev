	...
	<div class="col-md-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo $this->html('settings.textbox', 'notifications.polling.interval', 'COM_ES_NOTIFICATIONS_SETTINGS_POLLING_INTERVAL', '', array('postfix' => 'COM_EASYSOCIAL_SECONDS', 'size' => 5), '', 'text-center'); ?>
			</div>
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo $this->html('settings.textbox', 'notifications.broadcast.period', 'COM_EASYSOCIAL_NOTIFICATIONS_SETTINGS_BROADCAST_PERIOD', '', array('postfix' => 'COM_EASYSOCIAL_SECONDS', 'size' => 5), '', 'text-center'); ?>
			</div>
		</div>
