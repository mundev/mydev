	...
	<div class="col-md-6">
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo $this->html('settings.textbox', 'conversations.attachments.maxsize', 'COM_EASYSOCIAL_CONVERSATIONS_SETTINGS_ATTACHMENT_MAX_SIZE', '', array('postfix' => 'COM_ES_UNIT_MB', 'size' => 5), '', 'text-center'); ?>
			</div>
		</div>
	</div>
</div>
