...
<div class="row">
	<div class="col-md-6">
		...
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo $this->html('settings.textbox', 'comments.limit', 'COM_EASYSOCIAL_COMMENTS_SETTINGS_PAGINATION_LIMIT', '', array('postfix' => 'COM_EASYSOCIAL_COMMENTS_SETTINGS_PAGINATION_LIMIT_UNIT'), '', 'input-short text-center'); ?>
			</div>
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="panel">
			...
			<div class="panel-body">
				<?php echo $this->html('settings.toggle', 'comments.attachments', 'COM_EASYSOCIAL_COMMENTS_SETTINGS_ENABLE_ATTACHMENTS'); ?>
