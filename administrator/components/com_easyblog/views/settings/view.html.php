...
class EasyBlogViewSettings extends EasyBlogAdminView
{
	public function display($tpl = null)
	{
		...
		JToolbarHelper::custom('export', 'settings-export', '', JText::_('COM_EASYBLOG_EXPORT_SETTINGS'), false);
		JToolbarHelper::custom('import', 'settings-import', '', JText::_('COM_EASYBLOG_IMPORT_SETTINGS'), false);
