	...
	public function getEmbedHTML($url, $width = null, $height = null, $amp = false)
	{
		...
		if ($code) {
			...
			if ($amp) {
				...
				return '<amp-youtube data-videoid="' . $code . '" width="480" height="270"></amp-youtube>';
			}

			$iframeHtml = '<iframe ' . $width . $height . ' src="https://www.youtube.com/embed/' . $code . '?wmode=transparent" frameborder="0" allowfullscreen></iframe>';
		}
