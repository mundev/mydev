...
class EasyBlogTwitter extends EasyBlog
{
	...
	public function addCard(EasyBlogPost &$blog)
	{
		...
		// Add card definition.
		$this->doc->addCustomTag('<meta name="twitter:card" content="' . $cardType .'" />');
		$this->doc->addCustomTag('<meta name="twitter:url" content="' . $url . '" />');
		$this->doc->addCustomTag('<meta name="twitter:title" content="' . $title . '" />');
		...
		$this->doc->addCustomTag('<meta property="twitter:description" content="' . $description . '" />');
