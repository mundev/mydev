...
$posts = $model->getBlogsBy('', '', 'random', $count, EBLOG_FILTER_PUBLISHED, null, true, array(), false, false, true, array(), $categories, '', '', false);
...
require(JModuleHelper::getLayoutPath('mod_easyblograndompost', $params->get('layout', 'default')));
