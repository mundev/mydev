...
}}})};c(),b.resolveWith(c)})};FD50.module("textboxlist",a)}()}),FD50.installer("EasyBlog","definitions",function(a){a.module(["easyblog/shared/datetime","easyblog/shared/gallery","easyblog/shared/toggler","easyblog/admin/admin","easyblog/admin/grid","easyblog/admin/maintenance/database","easyblog/admin/maintenance/form","easyblog/admin/ordering","easyblog/admin/tabs","easyblog/admin/tag/suggest","easyblog/admin/toolbar"])}),FD50.installer("EasyBlog","scripts",function(){EasyBlog.module("shared/datetime",function(){var b=this;
...
if(e.length<=0)return alert(c.hints.empty),void 0;var f=a.data("type"),g=a.data("action");return"post"==f?(b.submitForm(g),void 0):("dialog"==f&&b.renderDialog(g),void 0)}}}),b.resolve()})});