...
var ab=a._=_();a.each(ab,function(b,c){Object.hasOwnProperty.call(ab,b)&&!/VERSION/.test(name)&&(a[b]||(a[b]=c))})}),FD40.plugin("bootstrap3",function(a){var b=a;window["Foundry/Bootstrap"]||(window["Foundry/Bootstrap"]={version:"3.0.3",foundry:b},+function(a){"use strict";function b(){var a=document.createElement("bootstrap"),b={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"};for(var c in b)if(void 0!==a.style[c])return{end:b[c]}
...
D&&(B.trigger=D),A.removeAttr(f)}k.hasAttribute(g)&&(B.value=A.attr(g),B.finalized=!0,A.removeAttr(g)),a.extend(z,B)}var E=new i(z);if(l>1&&null!==n&&(n.after=E,o=q(n)===!1))break;m=v,n=E}return o||q(n),p},getMarkerAt:function(a){if(void 0!==a){var c;return b.getMarkers(function(){return a>=this.start&&a<=this.end?(c=this,!1):void 0}),c}},getMarkersBetween:function(a,c){return void 0!==a?b.getMarkers(function(){return this.start>c?!1:this.end<a?null:this}):void 0},toArray:function(a,c){var d=b.getMarkers(function(){var c=this;
...
c.on("change",function(){b.fieldChanged(a)}),c.on("keyup",function(){b.fieldChanged(a)}),c.on("onFieldHide",function(){b.hideSelf(a)}),c.on("onFieldShow",function(){b.fieldChanged(a)}),c.hasClass("t-hidden")||b.fieldChanged(a)},getRequiredChecking:function(){var b=a("[data-conditional-check]").val();return b?JSON.parse(b):!1},fieldChanged:function(e){var f=b.getTargetedFieldValue(e);c.result[e]=b.checkCondition(f,e);var g=d.data("conditionsLogic");if(c.result){var h=!0;a.each(c.result,function(a,b){return"or"==g&&1==b?(h=!0,!1):(0==b&&(h=!1),void 0)
}),h?b.showSelf():b.hideSelf()}},checkCondition:function(a,d){var e=c.conditionValue[d],f=!1;switch(a=b.formatValue(a,d),c.operator[d]){case"equal":a==e&&(f=!0);break;case"not equal":a!=e&&(f=!0);break;case"contain":f=new RegExp("\\b"+e+"\\b","i").test(a)}return f},getTargetedFieldValue:function(c){var d=b.getTargetedField(c),f=(b.getTargetedFieldElement(c),d.find(":input")),g=[],h=!1;return f.length>0&&a.each(f,function(){var b=a(this),c=b.attr("type");if("hidden"!=c)switch(c){case"radio":radio=b.is(":checked")?1:0,radio&&(g=b.val());
break;case"checkbox":checkbox=b.is(":checked"),checkbox&&g.push(b.val());break;case"button":var d=b.parent(),e=d.find("input");"hidden"==e.attr("type")&&(g=e.val());break;default:b.val()&&(g=b.val())}}),a.isArray(g)?a.each(g,function(a,b){h=h?h+" "+b:b}):h=g,h},showSelf:function(){d.removeClass("t-hidden"),d.trigger("onFieldShow"),b.updateRequiredChecking(!0)},hideSelf:function(){d.addClass("t-hidden"),d.trigger("onFieldHide"),b.updateRequiredChecking(!1)},updateRequiredChecking:function(d){var e=b.getRequiredChecking();
e&&(e[c.id]=d,e=JSON.stringify(e),a("[data-conditional-check]").val(e))},getTargetedField:function(b){var d=a('[data-field-item][data-id="'+c.fieldTargeted[b]+'"]');return d},getTargetedFieldElement:function(a){var c=b.getTargetedField(a);return c.data("fieldItem")},formatValue:function(a,c){var d=b.getTargetedFieldElement(c);return"gender"==d&&a&&(a="1"==a?"male":"3"==a?"other":"female"),a},formatConditionsValue:function(a){var d=b.getTargetedFieldElement(a);"gender"==d&&("1"==c.conditionValue[a]&&(c.conditionValue[a]="male"),"2"==c.conditionValue[a]&&(c.conditionValue[a]="female"),"3"==c.conditionValue[a]&&(c.conditionValue[a]="other"))
...
},save:function(){var c=a.Deferred();if(!b.validate())return c.reject(),c;var d=b.fetchWorkflowData();return b.injectSaveData(d),c.resolve(),c},getAvailableFields:function(){return b.fetchWorkflowData(!1,!0)},fetchWorkflowData:function(d,e){var f=[],g=0,h=b.step();d&&(h=b.getCurrentStep()),a.each(h,function(d,h){var h=a(h),i=a(b.content.selector+'[data-id="'+h.data("id")+'"]'),j=[],k=[],l=i.find(b.field.selector);if(l.length>0){var m=0;if(a.each(l,function(b,d){var d=a(d);if(e)var f={fieldTitle:d.find("[data-field-item-title]").html(),fieldId:d.data("id"),fieldElement:d.data("element"),appId:d.data("appid")};
