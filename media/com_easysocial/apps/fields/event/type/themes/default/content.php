    ...
    <button class="btn-popdown dropdown-toggle_" type="button" data-bs-toggle="dropdown" data-popdown-button>
        ...
        <div data-popdown-active>
            <?php if ($value == 1 || !$value) { ?>
                ...
                <div class="btn-popdown__desp"><?php echo JText::_('FIELDS_EVENT_TYPE_PUBLIC_DESC');?></div>
            <?php } ?>
            ...
            <?php if ($value == 2) { ?>
                ...
                <div class="btn-popdown__desp"><?php echo JText::_('FIELDS_EVENT_TYPE_PRIVATE_DESC');?></div>
            <?php } ?>
            ...
            <?php if ($value == 3) { ?>
                ...
                <div class="btn-popdown__desp"><?php echo JText::_('FIELDS_EVENT_TYPE_INVITE_ONLY_DESC');?></div>
            <?php } ?>
        </div>

        <input type="hidden" value="<?php echo !$value ? 1 : $value;?>" name="event_type" />
    </button>
    ...
    <ul class="dropdown-menu dropdown-menu--popdown">
        <li class="<?php echo !$value || $value == 1 ? 'active' : '';?>" data-popdown-option="1">
            <a href="javascript:void(0);">
                ...
                <div class="dropdown-menu--popdown__desp"><?php echo JText::_('FIELDS_EVENT_TYPE_PUBLIC_DESC');?></div>
            </a>
        </li>
        <li class="<?php echo $value == 2 ? 'active' : '';?>" style="border-top: 1px solid #d7d7d7;" data-popdown-option="2">
            <a href="javascript:void(0);" style="padding: 12px 20px;">
                ...
                <div class="dropdown-menu--popdown__desp"><?php echo JText::_('FIELDS_EVENT_TYPE_PRIVATE_DESC');?></div>
            </a>
        </li>
        <li class="<?php echo $value == 3 ? 'active' : '';?>" style="border-top: 1px solid #d7d7d7;" data-popdown-option="3">
            <a href="javascript:void(0);" style="padding: 12px 20px;">
                ...
                <div class="dropdown-menu--popdown__desp"><?php echo JText::_('FIELDS_EVENT_TYPE_INVITE_ONLY_DESC');?></div>
            </a>
        </li>
    </ul>
</div>
