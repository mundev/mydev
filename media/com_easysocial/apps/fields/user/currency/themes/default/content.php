	...
	<div class="o-grid">
		<div class="o-grid__cell t-lg-pr--md">
			<div class="o-input-group">
				<input data-currency-dollar type="text" class="o-form-control" name="<?php echo $inputName; ?>[dollar]" value="<?php echo $dollar; ?>" />
		...
		<div class="o-grid__cell">
			<div class="o-input-group">
				<input data-currency-cent type="text" class="o-form-control" name="<?php echo $inputName; ?>[cent]" value="<?php echo $cent; ?>" />
