	...
	<?php } else { ?>
		...
		<div class="o-control-input">
			<div class="o-form-group" data-field-terms data-content>
				<textarea class="o-form-control" readonly="readonly" data-field-terms-textbox><?php echo JText::_($params->get('message', JText::_('PLG_FIELDS_TERMS_CONDITION_MESSAGE_TERMS')));?></textarea>
			</div>
