	...
	<div class="o-media">
		...
		<div class="o-media__body">
			<div class="o-input-group">
				<input type="text" class="o-form-control" data-field-multitextbox-input name="<?php echo $inputName; ?>[]" value="<?php echo $value; ?>" placeholder="<?php echo JText::_($placeholder); ?>" />
