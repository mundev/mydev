...
?>
<div data-field-easyblog-adsense>
	...
	<textarea class="o-form-control input-sm" id="<?php echo $inputName;?>" rows="5" name="<?php echo $inputName;?>" data-field-easyblog-adsense-input <?php echo $field->isRequired() ? ' data-check-required' : '';?> ><?php echo html_entity_decode($adsense->code); ?></textarea>
...
google_ad_height =60;
	...
	<select name="<?php echo $inputName;?>-adsense-display" class="o-form-control">
