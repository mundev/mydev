...
?>
<div>
	<ul class="input-vertical list-unstyled" <?php if( $params->get( 'format' , 1 ) != 1 ) { ?>style="display: none;"<?php } ?>>
		<li>
			<div class="fd-small"><?php echo JText::_( 'PLG_FIELDS_EASYBLOG_ENABLE_ADSENSE' );?>:</div>
			...
			<div><textarea class="o-form-control input-sm" id="easyblog-adsense" rows="5" name="easyblog-adsense" data-field-easyblog-adsense-input></textarea></div>
...
google_ad_height =60;
			...
			<select name="easyblog-adsense-display" class="o-form-control">
