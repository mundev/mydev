...
<div class="es-locations" data-location-base>
	...
	<div class="es-location-map" data-location-map data-latitude="<?php echo ES::string()->escape($value->latitude); ?>" data-longitude="<?php echo ES::string()->escape($value->longitude); ?>">
