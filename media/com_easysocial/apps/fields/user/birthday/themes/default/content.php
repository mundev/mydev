...
<div data-field-datetime class="form-inline">
	...
	<div class="es-field-datetime-form with-border with-calendar mb-5" data-field-datetime-form>
		<div class="es-field-datetime-textbox">
			...
			<input class="datepicker-wrap o-form-control input-sm" data-field-datetime-select data-date="<?php echo $date; ?>" type="text" placeholder="<?php echo JText::_($params->get('placeholder')); ?>" />
		</div>
	...
	<?php if ($yearPrivacy) { ?>
		<div class="data-field-datetime-yearprivacy t-lg-mt--md">
			<div class="t-pull-right">
				<?php echo FD::privacy()->form($field->id, 'birthday.year', $user->id, 'field.birthday.year');?>
			</div>
