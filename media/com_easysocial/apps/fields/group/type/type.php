	...
	private function getDropdownForms($value = null, $registration = null)
	{
		$defaults = array(
				SOCIAL_GROUPS_PUBLIC_TYPE => array(
						SOCIAL_GROUPS_PUBLIC_TYPE, 'PLG_FIELDS_GROUP_TYPE_PUBLIC', 'PLG_FIELDS_GROUP_TYPE_PUBLIC_DESC', 'fa-globe'
					),
				SOCIAL_GROUPS_SEMI_PUBLIC_TYPE => array(
						SOCIAL_GROUPS_SEMI_PUBLIC_TYPE, 'PLG_FIELDS_GROUP_TYPE_SEMI_PUBLIC', 'PLG_FIELDS_GROUP_TYPE_SEMI_PUBLIC_DESC', 'fa-globe'
					),
				SOCIAL_GROUPS_PRIVATE_TYPE => array(
						SOCIAL_GROUPS_PRIVATE_TYPE, 'PLG_FIELDS_GROUP_TYPE_PRIVATE', 'PLG_FIELDS_GROUP_TYPE_PRIVATE_DESC', 'fa-user'
					),
				SOCIAL_GROUPS_INVITE_TYPE => array(
						SOCIAL_GROUPS_INVITE_TYPE, 'PLG_FIELDS_GROUP_TYPE_INVITE_ONLY', 'PLG_FIELDS_GROUP_TYPE_INVITE_ONLY_DESC', 'fa-lock'
					)
			);
